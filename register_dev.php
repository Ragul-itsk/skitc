    ...
    <section class="contact_area " style="padding: 50px 0 50px 0;">
        <div class="container">
            <div class="bg-img">
                ...
                <form action="web_develop_register.php" method="post" id="" autocomplete="off" class="form_container">
                    ...
                    <div class="mt-10">
                        <input type="text" name="website_name" placeholder="Whatsapp Number" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Whatsapp Number'" class="form-control">
                    </div>

                    <!--  <div class="mt-10">


                    <input type="text" id="subdomain" name="subdomain" placeholder="Sub Domain"  onfocus="this.placeholder = ''" onblur="this.placeholder = 'Sub Domain'" class="form-control" >
