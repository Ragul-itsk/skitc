            ...
            <div class="comparison">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>&nbsp;</td>
                            <td colspan="4" style="width: 100%;"><a href="register_dev.php" style="color: #777777;">Free Registration</a></td>
                        </tr>
                        <tr class="compare-row">
                            <td colspan="5" style="background-color: #3bacf0;text-align: -webkit-center;"><a href="register_dev.php" class="tickets_btn">Free Trial</a></td>
                        </tr>
