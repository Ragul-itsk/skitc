...
require_once("Includes/fca_head.php");
...
<body>
				...
				<div class="row">
					<div class="col-lg-5">
						<div class="banner_content">
							<h2>Find Courses Abroad</h2>
							<p>Search for a Course from Universities around the world.</p>
							<a class="banner_btn" href="pricing.php">Get Started</a>
							<a class="banner_btn2" href="http://www.findcoursesabroad.com/">Free Trial</a>
						</div>
					</div>
					<div class="col-lg-7">
						<div class="home_left_img">
							<img class="img-fluid" src="img/new_n/finc_ban.png" alt="">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="work_inner row">
				<div class="col-lg-4">
					<div class="work_item">
						...
						<p>Whether you are looking for information on visa requirements or funding options, you will find all the advice you need here.</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="work_item">
						...
						<p>We make it easy to build a shortlist of the courses you want to study.</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="work_item">
						...
						<p> Our course search tool gives you access to thousands of courses from institutions around the world.
						</p>
					</div>
				</div>
			</div>
				...
				<div class="row made_life_text">
					<div class="col-lg-6">
						<div class="left_side_text">
							...
							<h3>Powerful Course Search</h3>
							<h6>Our course search tool gives you access to thousands of courses from institutions around the world. </h6>

							1. Helps overseas education consultant to maintain all database of the students properly<br>
							2. Guide the students to achieve their dream as Global graduates.<br>
							3. Cheap and best portal for to search the courses and also easy to maintain the databases<br>
							4. Can search for any courses in multiple universities and colleges throughout the world<br>
							5. Our Extraordinary technology helps to match your grades and budget.<br>
							Once you register with us, we will send all updates in every stage of the process.<br>
							6. 24x7 services, through calls and email.<br>
					...
					<div class="col-lg-6">
						<div class="chart_img">
							<img class="img-fluid" src="img/new_n/finc_2.png" alt="">
						</div>
					</div>
				</div>
			</div>
	...
	<section class="screen_area text-center p_120">
		<div class="container">
			<div class="main_title">
				<h2>Our easy to use search tools make it easy to find your perfect course</h2>
				<p></p>
			</div>
			<img class="img-fluid" src="img/new_n/finc_3.png" alt="">
		</div>
	</section>
	<!--================End Screen Area =================-->
				...
				<div class="row made_life_text">
					...
					<div class="col-lg-6">
						<div class="left_side_text">
							...
							<h6>Find Courses Abroad provides a large database of courses from universities all over the world.</h6>
