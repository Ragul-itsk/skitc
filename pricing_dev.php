                ...
                <table>
                    <thead>
                        ...
                        <tr id="dollar" class="nonetoggle">
                            <th></th>
                            <th class="price-info">
                                <div class="price-now"><span>$82<span class="price-small">.48 </span><span class="price-tax">+ GST</span>
                            ...
                            <th class="price-info">
                                <div class="price-now"><span>$206<span class="price-small">.23</span><span class="price-tax">+ GST</span>
                                        <p class="price-type">per user / month</p>
                                    </span></div>
                            ...
                            <th class="price-info">
                                <div class="price-now"><span>$343<span class="price-small">.72</span><span class="price-tax">+ GST</span>
                                        <p class="price-type">per user / month</p>
                                    </span></div>
                        ...
                        <tr id="rupee" class="">
                            <th></th>
                            <th class="price-info">
                                <div class="price-now"><span>&#2352;5999 <span class="price-small">.00 </span><span class="price-tax"></span>
                            ...
                            <th class="price-info">
                                <div class="price-now"><span>&#2352;7999 <span class="price-small">.00 </span><span class="price-tax"></span>
                                        <p class="price-type"></p>
                                    </span></div>
                                <div><a href="register_dev.php?plan='premium'" class="price-buy">Buy <span class="hide-mobile">Now</span></a>
                                    <!--                            <p class="min_user">**NOTE MINIMUM 4 USERS </p>-->
                            ...
                            <th class="price-info">
                                <div class="price-now"><span>&#2352;12999 <span class="price-small">.00</span><span class="price-tax"></span>
                                        <p class="price-type"></p>
                                    </span></div>
                                <div><a href="register_dev.php?plan='enterprise'" class="price-buy">Buy <span class="hide-mobile">Now</span></a>
                                    <!--                            <p class="min_user">**NOTE MINIMUM 4 USERS </p>-->
                            ...
                            <th class="price-info">
                                <div class="price-now"><span>Negotiable<span class="price-tax"></span>
                                        <p class="price-type"></p>
                                    </span></div>
                                <div><a href="register_dev.php?plan='unlimited'" class="price-buy">Buy <span class="hide-mobile">Now</span></a>
                                    <!--                            <p class="min_user">**NOTE MINIMUM 4 USERS </p>-->
