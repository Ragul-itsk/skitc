...
<body>
	...
	<section class="contact_area " style="padding: 50px 0 50px 0;">
		<div class="container">
			<div class="bg-img">
				...
				<form action="register/free_try_insert.php" method="post" id="free_try" autocomplete="off" class="form_container">
					<h3 class="mb-10 title_color" style="text-align: center;">Free Trial Register</h3>


					<div class="mt-10">
						<input type="text" name="name" placeholder="Your Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Name'" required class="form-control">
					</div>
					...
					<!-- <div class="mt-10">
										<input type="text" name="website_name" placeholder="Website Name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Website Name'" required class="form-control">
									</div> -->
					...
					<div class="mt-10 text-center" style="padding-bottom: 10px;">
						<button type="submit" value="submit" name="register" class="genric-btn success" id="free_submit_btn">Download</button>
					</div>

					<div id="hid_text" style="display: none; color: green"> <i class="fa fa-check" aria-hidden="true"></i>&nbsp; Send successfully</div>
	...
	<script>
		$(document).ready(function() {
			$("#free_submit_btn").click(function() {
				$("#free_try").submit(); // Submit the form
				$("#hid_text").css("display", "block");
			});
		});
	</script>
            ...
            <div class="container">
				...
				<div class="col-md-2">
                    ...
                    <div class="col-md-8">
								...
								<h3 class="mb-10 title_color">Free Trial Register</h3>
								<form action="register/free_try_insert.php" method="post" id="free_try" autocomplete="off">
		...
		$(document).ready(function(){
			$('#subdomain').keyup(function(e){
				...
				$.ajax({
					...
					data: {keyword: subdomain,domain: domain,},
					dataType: 'json',
