...
<body>
	<div class="body-inner">
		...
		<!-- ts intro start -->
		<section class="ts-intro intro-line section-bg" style="background-color:white;">
			<div class="container">
				<div class="row">
			   ...
			   <?php
				...
				<hr> -->
						...
						<h3 class="text-center">Amount To Wallet</h3>

						<div class="row">
							<div class="col-md-2"></div>
							<div class="col-md-2">
								<form method="POST" action="paykun-php-master/demo/submit.php">
									<input type="hidden" name="product_name" value="<?php echo $data['Name'] ?>">
									<!-- <input type="email" name="email"> -->
									<input type="hidden" name="amount" value="10">
									<input type="hidden" name="contact" value="<?php echo $data['Mobile'] ?>">
									<input class="btn btn-info btn-lg" type="submit" value="10 Rs">
								</form>
							</div>
							<div class="col-md-2">
								<form method="POST" action="paykun-php-master/demo/submit.php">
									...
									<input type="hidden" name="contact" value="<?php echo $data['Mobile'] ?>">
									<input class="btn btn-info btn-lg" type="submit" value="50 Rs">
								</form>
							</div>
							<div class="col-md-2">
								<form method="POST" action="paykun-php-master/demo/submit.php">
									...
									<input type="hidden" name="contact" value="<?php echo $data['Mobile'] ?>">
									<input class="btn btn-info btn-lg" type="submit" value="100 Rs">
								</form>
							</div>
							<div class="col-md-2">
								<form method="POST" action="paykun-php-master/demo/submit.php">
									...
									<input type="hidden" name="contact" value="<?php echo $data['Mobile'] ?>">
									<input class="btn btn-info btn-lg" type="submit" value="500 Rs">
								</form>
							</div>
							<div class="col-md-2"></div>
